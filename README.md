...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Version-1.9.43-FF6B6B?style=flat-square" alt="Version">
</p>
...
| 版本 | 下载链接 | 文件大小 |
|:---:|:---:|:---:|
| 最新版 (v1.9.43) | [点击下载](https://file.awen.me/music/melody_player_v1.9.43.apk) | ~52 MB |
...
### v1.9.43 (2026-02-20)
- 🔧 修复播放阻塞 - 不在 setPlaylist 中为所有歌曲预生成封面，只给当前播放歌曲生成

### v1.9.42 (2026-02-20)
- 🔧 紧急修复 - 移除 `on_audio_query` 在后台的使用，修复无法播放的问题
- 🔧 统一使用应用生成的渐变色封面作为通知栏缩略图
...
### v1.9.37 (2026-02-20)
- 🔧 修复通知栏缩略图 URI 路径（external_cache）

### v1.9.35 (2026-02-20)
- 🎨 后台通知栏无封面歌曲显示渐变色缩略图（与应用内样式一致）
- 🔧 使用 FileProvider 生成 content:// URI 供系统通知栏使用

### v1.9.33 (2026-02-20)
- 🔧 修复切歌不正常工作的问题

### v1.9.32 (2026-02-20)
- 📺 新增 Google Cast 投屏开关和界面
